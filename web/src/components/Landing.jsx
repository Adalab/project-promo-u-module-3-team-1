...
function Landing() {
  ...
  const dataPreview2 = {
    ...
    autor: 'Ada Lovelace',
    job: 'Mathematician',
    image: 'https://pilarsabariego.com/wp-content/uploads/2018/11/ada-lovelace-20825279-1-402.jpg',
    photo: 'photo',
  }
  const dataPreview3 = {
    ...
    image: 'https://www.kth.se/polopoly_fs/1.979357.1600722698!/image/Hedy_lamarr.jpg',
    photo: 'photo',
  }
  const dataPreview4 = {
    ...
    image: 'https://iuploads.scribblecdn.net/ffe8e2ab-75f9-4bb4-99d8-d622902e2419/global/imagelib/women_at_technology/500x500_grace-hopper-1806479303ea40a62cbfc0571db3df4ef405d919.png?v=03052021202502',
    photo: 'photo',
  }
  return (
